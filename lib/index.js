...
import { TouchableOpacity, View, Text, Modal, StyleSheet, Image, } from 'react-native';
    ...
    render() {
        ...
        return (React.createElement(View, null,
            ...
            logout && (React.createElement(View, { style: { width: 1, height: 1 } },
                React.createElement(WebView, { source: { uri: LOGOUT_URL }, javaScriptEnabled: true, domStorageEnabled: true, sharedCookiesEnabled: true, incognito: true, onLoadEnd: () => this.setState({ logout: false }) })))));
    }
}
